...
angular.module('tripStoryApp.landingPage', ['ngRoute'])
.config(['$routeProvider', function($routeProvider) {


  $routeProvider.when('/landingpage', {
    templateUrl: '/static/js/landingpage/landingpage.html',
    controller: 'LandingPageController as lpCtr'
  });
}])


.controller('LandingPageController', ['$scope', '$location', 'Backend', '$rootScope',
        '$sce', '$routeParams',
    ...
    $scope.populateMap = function(data) {
      ...
      for (var j = 0; j < data.trips.length; j++) {
          ...
          var content = "<div id='container'><blockquote>" + data.trips[j]['name']
                        + "<br /><a style='margin-top: 5px;' href='#register"
